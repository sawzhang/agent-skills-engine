...
class TestPathMetadata:
    ...
    def test_custom_values(self) -> None:
        ...
        meta = PathMetadata(
            ...
            scope="user",
            origin="package",
            base_dir="/home/user/.agent-skills",
        )

        assert meta.source == "pypi"
        assert meta.scope == "user"
        assert meta.origin == "package"
        assert meta.base_dir == "/home/user/.agent-skills"
...
class TestPackageManager:
    ...
    def test_load_manifest_no_agent_skills_section(self, tmp_path: Path) -> None:
        """Should return None when pyproject.toml has no agent-skills section."""
    ...
    def test_resolve_skips_empty_manifests(self, tmp_path: Path) -> None:
        ...
        # Package with empty agent-skills section
