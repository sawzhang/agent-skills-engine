...
from agent_skills_engine.models import Skill, SkillSnapshot, SkillSource
from agent_skills_engine.runtime import BashRuntime, ExecutionResult, SkillRuntime
...
class SkillsEngine:
    ...
    def _format_xml(self, skills: list[Skill]) -> str:
        """Format skills as XML (Agent Skills standard)."""
        if not skills:
            return ""
