...
try:
    ...
    raise ImportError(
        ...
        "Install with: pip install agent-skills-engine[web]"
    )

from agent_skills_engine.web.storage import SessionStorage
...
def create_app(agent: Any = None, storage: SessionStorage | None = None) -> Starlette:
    ...
    async def index(request: Request) -> HTMLResponse:
        ...
        return HTMLResponse("<h1>Agent Skills Engine</h1><p>Static files not found.</p>")
