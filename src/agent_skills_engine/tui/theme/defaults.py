...
:data:`~agent_skills_engine.tui.theme.models.ALL_COLOR_KEYS`.
"""

from __future__ import annotations

from agent_skills_engine.tui.theme.models import ThemeColor, ThemeInfo
