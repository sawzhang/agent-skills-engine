...
Requires the 'anthropic' extra: pip install skillkit[anthropic]
"""
...
class AnthropicAdapter(LLMAdapter):
    ...
    Example:
        ...
        from skillkit.adapters import AnthropicAdapter
