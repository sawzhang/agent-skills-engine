...
from skillkit.models import Skill, SkillSnapshot, SkillSource
from skillkit.runtime import BashRuntime, ExecutionResult, SkillRuntime
...
class SkillsEngine:
    ...
    def _format_xml(self, skills: list[Skill]) -> str:
        """Format skills as XML (SkillKit standard)."""
        if not skills:
            return ""
